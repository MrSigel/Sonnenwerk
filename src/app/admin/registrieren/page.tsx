...
export default function AdminRegisterPage() {
  const configured = hasSupabaseServer();
  return (
    <div className="flex min-h-screen items-center justify-center px-5 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="card mt-8 p-6">
          <h1 className="text-h3 font-semibold text-ink">Registrieren</h1>
          <p className="mt-1 text-small text-ink-soft">
            Die Registrierung ist nur mit einem gültigen Einladungscode möglich.
          </p>
          ...
          <p className="mt-6 text-small text-ink-soft">
            Bereits registriert?{" "}
            <Link href="/admin/login" className="text-accent underline underline-offset-2">
              Zur Anmeldung
            </Link>
          </p>
        </div>
